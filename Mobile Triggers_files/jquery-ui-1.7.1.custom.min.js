 ...
 * Depends:
 *	ui.core.js
 */(function(a){a.widget("ui.accordion",{_init:function(){var d=this.options,b=this;this.running=0;if(d.collapsible==a.ui.accordion.defaults.collapsible&&d.alwaysOpen!=a.ui.accordion.defaults.alwaysOpen){d.collapsible=!d.alwaysOpen}if(d.navigation){
	...
	if(c.length ){
		if(c.filter(d.header).length){
			...
			var parent_check = c.parent().attr('id');
			if( parent_check == 'submenu_second_level' ){
				this.active=c.parent().parent().parent().prev();c.addClass("ui-accordion-content-active")
			}else{
				this.active=c.parent().parent().prev();c.addClass("ui-accordion-content-active")
			}
		}
	}
