	...
	$.extend($.fn, {
		...
		miniColors: function(o, data) {
			...
			var show = function(input) {
				...
				selector
					.append('<div id="miniColors-colors" class="miniColors-colors" style="background-color: #FFF;"  ><div class="miniColors-colorPicker" onmousedown="changecolor();"><div class="miniColors-colorPicker-inner" ></div></div>')
			...
			var setColor = function(input, hsb, updateInput) {
				...
				//$('.pass-backg').css("background-color", '#' + hex);
