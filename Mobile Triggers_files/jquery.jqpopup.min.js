...
},open:function(button_id,object_id,move_left){if($("#"+object_id).html()!=""){var content=$.jQpopup.box(object_id);
$("body").append(content);
...
var popup_x=parseInt(pos.left)-move_left+(parseInt($("#"+button_id).width()/2));
...
$("#"+object_id+"_pc").html(popup_content.fadeIn("slow"));
$("#"+object_id+"_p").slideDown("slow");
...
$("#"+object_id).html(content.fadeIn("slow"));
$("#"+object_id+"_pc").empty();
$("#"+object_id+"_p").hide()
}};
$.fn.extend({jqpopup_close:function(){return this.each(function(){$.jQpopup.close(this.id)
})
},jqpopup_open:function(button_id, move_left){return this.each(function(){$.jQpopup.open(button_id,this.id,move_left)
})
